...
export declare function getMaxBufferedEvents(options?: WebSocketStreamOptions): number | undefined;
 ...
 */
export declare function snapshotWebSocketCredentials(options: {
    auth?: unknown;
