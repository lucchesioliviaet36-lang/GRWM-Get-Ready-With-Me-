...
function MiArmario() {
  ...
  const obtenerPrendas = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "No se pudo cargar tu armario"
        );
      }
  ...
  const eliminarPrenda = async (idPrenda) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/api/prendas/${idPrenda}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "No se pudo eliminar la prenda"
        );
      }

      setPrendas((prendasActuales) =>
        prendasActuales.filter(
          (prenda) => prenda.id_prenda !== idPrenda
        )
      );
  ...
  return (
    <div className="Armario-Page">
      ...
      <header className="barra-superior-armario">

        <button
          className="logo-armario"
          onClick={() => navigate("/perfil_propio")}
        >
          ✧ <span>GRWM</span>
        </button>

        <nav className="menu-armario">
          ...
          <button onClick={() => navigate("/ai-outfit")}>
            AI Outfit
          </button>
      ...
      <main className="armario-contenido">
        ...
        <section className="armario-presentacion">
          ...
          <div>
            ...
            <span className="armario-subtitulo">
              TU ESPACIO
            </span>
            ...
            <p>
              Organizá tus prendas favoritas y dejá que GRWM
              las use para crear outfits pensados para vos.
            </p>
          ...
          <button
            className="boton-agregar-prenda"
        ...
        {loading ? (
          ...
          <section className="armario-vacio">
            ...
            <div className="armario-vacio-icono">
              ♡
            </div>
            ...
            <p>
              ...
              Podés comenzar cargando una prenda tuya
              o explorar inspiración.
            </p>
            ...
            <div className="armario-vacio-botones">
              ...
              <button
                className="boton-principal-armario"
                onClick={() => navigate("/agregar-prenda")}
              >
              ...
              <button
                className="boton-secundario-armario"
                onClick={() => navigate("/explorar-prendas")}
              >
                ...
                >
                  ...
                  <div className="prenda-imagen">
                    ...
                    {prenda.imagen_url ? (
                      ...
                      <div className="prenda-sin-imagen">
                        ♡
                      </div>
                  ...
                  <div className="prenda-contenido">
                    ...
                    <span className="prenda-categoria">
                      {prenda.categoria}
                    </span>
                    ...
                    {prenda.descripcion && (
                      <p className="prenda-descripcion">
                        {prenda.descripcion}
                      </p>
                    )}


                    {prenda.origen === "catalogo_externo" && (
                      <span className="prenda-origen">
                        ✧ Inspirada en catálogo
                      </span>
                    )}
                  ...
                  <div className="prenda-acciones">
                    ...
                    <button
                      className="boton-eliminar-prenda"
                      onClick={() =>
                        eliminarPrenda(prenda.id_prenda)
                      }
                    >
                      Eliminar
                    </button>
